...
const {
    ...
    formatSlaState,
    formatDate,
} = useAgentTicketShow(props);
</script>

<template>
    <Head :title="`[Agent] Ticket #${ticket.id}`" />
                        ...
                        <div class="bg-white rounded-xl border border-slate-200/80 shadow-sm p-6 space-y-6">
                            ...
                            <form @submit.prevent="submitAction" class="space-y-6">
                                ...
                                <button
                                    ...
                                    class="w-full inline-flex justify-center items-center px-4 py-2.5 bg-slate-800 hover:bg-slate-700 active:bg-slate-900 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 disabled:opacity-50 transition ease-in-out duration-150 shadow-sm"
                                >
                                    Apply Changes
                                </button>
                            </form>
